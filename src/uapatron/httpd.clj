...
(defn routes []
  [["/" #'ui.index/index]
   ...
   ["/payment/fondy" #'ui.payment/result]
   ["/payment/solidgate" #'ui.payment/result]
   ["/api/payment/fondy" #'api.payment/payment-callback]
   ["/api/payment/solidgate" #'api.payment/payment-callback]
